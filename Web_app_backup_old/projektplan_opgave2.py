...
app.title = "Simpel Bølgeligning fra projektplan med beg(5)"
...
def compute_wave_propagation(L, w, k0, v, N, dt, T):
    ...
    u_numerical[1:, :] = 2*A_numerical[0, :] *np.cos(np.sqrt(k**2+1)*dt*n_values)
...
def update_line_plot(time_step, n_clicks, L, w, k0, v, N, dt, T):
